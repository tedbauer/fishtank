...
export const translations = {
    en: {
        ...
        // tab_schedule: removed — schedule is folded into Week/Month tabs
        min_short: "min",
        min_short_compact: "m",
        hour_short: "h",
        minutesLabel: "Time",
        minutesPlaceholder: "min",
        todayTimeTotal: "About {time} today · {n} left",
        todayTimeUnknown: "{n} on today's list",
        todayTimeMissing: "{n} no estimate",
        progress_count: "{done} of {total} done",
        progress_letsGo: "let's go!",
        progress_keepGoing: "keep going",
        progress_halfway: "halfway there!",
        progress_almostThere: "almost done!",
        progress_allDone: "all done — nice work!",
        progress_timeLeft: "about {time} left",
        doneToday: "Done today ({n})",
        weekTimeTotal: "{time} this week · {n} chores",
        weekTimeCount: "{n} this week",
        monthTimeTotal: "{time} this month · {n} chores",
        monthTimeCount: "{n} this month",
        dayRemainingTime: "{time} · {n} left",
        dayRemainingCount: "{n} left",
        tab_heatmap: "Heatmap",
        tab_store: "Store",
        tab_manage: "Manage",
        signOut: "Sign Out",
        ...
        schedule_runOn: "Runs on:",
        schedule_dayOfMonth: "Day of month:",
        schedule_weekA: "Week A",
        schedule_weekB: "Week B",
        schedule_emptyDay: "Nothing scheduled.",
        doneShort: "done",
        dow_short_0: "Sun",
        dow_short_1: "Mon",
        dow_short_2: "Tue",
        ...
        hi: "Hi, {name}!",
        partner: "Partner",
        tankStateHealthy: "Healthy",
        tankStateRecovering: "Recovering",
        tankStateThriving: "Thriving",
        noStreak: "No Streak",
        streakStart: "Start one today",
        dayStreak: "Day Streak",
        choresLeft: "Chores Left",
        usersChores: "{name}'s Chores",
        shop: "Shop →",

        // Comeback / catching-up state (broken streak + away for a while)
        comebackHeadline: "Welcome back, {name}!",
        comebackBody: "Just one chore today and you're back on track.",
        comebackPreviewLabel: "If you do one today:",
        comebackStreakPreview: "Streak {from} → {to}",
    ...
    vi: {
        ...
        // tab_schedule: removed
        min_short: "phút",
        min_short_compact: "p",
        hour_short: "giờ",
        minutesLabel: "Thời gian",
        minutesPlaceholder: "phút",
        todayTimeTotal: "Khoảng {time} hôm nay · còn {n}",
        todayTimeUnknown: "{n} việc hôm nay",
        todayTimeMissing: "{n} chưa ước tính",
        progress_count: "{done} / {total} xong",
        progress_letsGo: "bắt đầu nào!",
        progress_keepGoing: "tiếp tục nha",
        progress_halfway: "được nửa rồi!",
        progress_almostThere: "sắp xong!",
        progress_allDone: "xong rồi — giỏi quá!",
        ...
        monthTimeTotal: "{time} tháng này · {n} việc",
        monthTimeCount: "{n} việc tháng này",
        dayRemainingTime: "{time} · còn {n}",
        dayRemainingCount: "còn {n}",
        tab_heatmap: "Biểu đồ",
        tab_store: "Cửa hàng",

        schedule_runOn: "Lặp vào:",
        schedule_dayOfMonth: "Ngày trong tháng:",
        schedule_weekA: "Tuần A",
        schedule_weekB: "Tuần B",
        schedule_emptyDay: "Không có gì.",
        doneShort: "xong",
        dow_short_0: "CN",
        dow_short_1: "T2",
        dow_short_2: "T3",
        ...
        hi: "Chào, {name}!",
        partner: "Bạn đời",
        tankStateHealthy: "Khoẻ mạnh",
        tankStateRecovering: "Đang hồi phục",
        tankStateThriving: "Rực rỡ",
        noStreak: "Chưa có chuỗi",
        streakStart: "Bắt đầu hôm nay",
        dayStreak: "Ngày liên tiếp",
        comebackHeadline: "Mừng bạn quay lại, {name}!",
        comebackBody: "Chỉ một việc hôm nay là bạn trở lại đúng nhịp.",
        comebackPreviewLabel: "Nếu bạn làm một việc hôm nay:",
        comebackStreakPreview: "Chuỗi {from} → {to}",

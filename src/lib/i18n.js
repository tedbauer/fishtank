...
export const translations = {
    en: {
        ...
        tq_recovery: "Recovery bonus (chore done today)",
        ...
        comebackTankPreview: "Tank {from} → {to}",
        comebackPilePeek: "Show {n} catching up",
        comebackPileHide: "Hide",
        comebackCatchingUp: "Catching up ({n})",
        catchingUpShort: "{n}d catching up",
    ...
    vi: {
        ...
        tq_recovery: "Thưởng phục hồi (đã làm việc hôm nay)",
        ...
        comebackTankPreview: "Bể {from} → {to}",
        comebackPilePeek: "Xem {n} việc cần bắt kịp",
        comebackPileHide: "Ẩn",
        comebackCatchingUp: "Đang bắt kịp ({n})",
        catchingUpShort: "trễ {n} ngày, đang bắt kịp",
